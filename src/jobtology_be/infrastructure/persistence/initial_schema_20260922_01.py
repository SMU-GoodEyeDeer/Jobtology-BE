"""Immutable schema snapshot for application revision 20260922_01."""
...
recompute_requests = Table(
    ...
    Column("user_id", UUID(as_uuid=True), ForeignKey("users.id"), nullable=False),
    Column("profile_version", BIGINT, nullable=False),
    Column("trigger_event_id", UUID(as_uuid=True), ForeignKey("user_state_events.id"), nullable=False),
